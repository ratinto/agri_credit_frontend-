...
const features = [
    {
        icon: <Smartphone color="var(--color-evergreen)" />,
    ...
    {
        icon: <Shield color="var(--color-evergreen)" />,
    ...
    {
        icon: <CloudSun color="var(--color-evergreen)" />,
    ...
    {
        icon: <Brain color="var(--color-evergreen)" />,
                        ...
                        >
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginTop: '1.5rem' }}>
                                {f.details.map((detail, j) => (
                                    <div key={j} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', color: 'var(--color-evergreen)' }}>
                                        <Sprout size={14} />
                                        <span>{detail}</span>
                                    </div>
                                ))}
